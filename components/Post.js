...
import {deleteDoc, setDoc,onSnapshot,query,orderBy,addDoc,collection,doc,serverTimestamp,} from "@firebase/firestore"
...
console.log(hasLiked)
    ...
    )}  { likes.length >1 &&   (  <p className="font-bold mb-1">{likes.length} likes</p>
    )}
